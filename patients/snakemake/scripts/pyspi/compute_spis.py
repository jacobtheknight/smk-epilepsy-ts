# Compute patient pairwise connectivity matrices from 284 pairwise interaction statistics using pyspi (https://github.com/DynamicsAndNeuralSystems/pyspi)
...
# load timeseries
subject_ts = pd.read_csv(snakemake.input.vep_timeseries_labelled, index_col=0)
