# Preprocess and parcellate healthy control BOLD time series using the Virtual Epileptic Patient atlas (https://github.com/HuifangWang/VEP_atlas_shared)
...
# load Virtual Epileptic Patient atlas (Wang et al., 2020) from subject Freesurfer
...
# load BOLD reference image for inspection
bold_ref_img = nib.load(snakemake.input.bold_ref)
