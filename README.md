...
- BOLD time series parcellation
- Labelling of time series using epileptogenciity index (EI) from SEEG
...
- Patient EI data (expects EZ, PZ and NI labels assigned to VEP atlas regions)
